...
import com.snegirekk.books_library.review.dto.ConstraintViolationListDto;
import com.snegirekk.books_library.review.dto.ConstraintViolationDto;
import com.snegirekk.books_library.review.dto.ErrorDto;
import com.snegirekk.books_library.review.exception.BookLibraryException;
import com.snegirekk.books_library.review.exception.ReviewNotFoundException;
...
public class V1ApiController {
    ...
    public ResponseEntity<ConstraintViolationListDto> handleMethodArgumentNotValidException(MethodArgumentNotValidException exception) {
        ...
        List<ConstraintViolationDto> violations = result.getAllErrors().stream()
                .map(error -> new ConstraintViolationDto(
    ...
    public ResponseEntity<ErrorDto> handleAppException(BookLibraryException exception) {
        ...
        if (exception.getClass().equals(ReviewNotFoundException.class) || exception.getClass().equals(InvalidPageNumberException.class)) {
